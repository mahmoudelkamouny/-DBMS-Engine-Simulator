...
public abstract class BPTreeNode<T extends Comparable<T>> implements Serializable{
	 ...
	 */
	public abstract PushUp<T> insert(T key, Ref recordReference, BPTreeInnerNode<T> parent, int ptr,String col_name,String table_name);
	...
	public abstract boolean update(T key,Ref old_reference,Ref new_reference,int ptr,BPTreeInnerNode<T> parent,boolean flag);
	public abstract boolean update_for_insert(T key, Ref old_refrence,Ref new_refrence,int ptr, BPTreeInnerNode<T> parent);
	public abstract boolean delete_using_Ref(T key, Ref r, BPTreeInnerNode<T> parent, int ptr);
}
